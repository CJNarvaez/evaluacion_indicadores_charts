...
$.extend( $.validator, {
	...
	messages: {
		...
		remote: "Por favor corrige este valor.",
		email: "Por favor introduce un email valido.",
		url: "Por favor introduce una URL valida.",
		date: "Por favor introduce una fecha valida.",
		dateISO: "Por favor introduce una fecha valida ( ISO ).",
		number: "Por favor introduce un numero valido.",
		digits: "Por favor introduce solo digitos.",
		creditcard: "Por favor introduce un número de tarjeta de credito valido.",
		equalTo: "Por favor introduce nuvamente el mismo valor.",
		maxlength: $.validator.format( "Por favor no introducir mas de {0} caracteres." ),
